...
function CentrosCompetencia() {
        ...
        try {
            ...
            cursos.forEach((curso)=>{
                ...
                if (datos) {
                    try {
                        ...
                        console.log('Error parseando datos de competición:', e);
                    }
                }
            });
            ...
            if (datosDocentes) {
                try {
                    ...
                    console.log('Error parseando datos de competición de docentes:', e);
                }
            }
    ...
    const obtenerPremiosDelMes = ()=>{
        ...
        if (premiosGuardados) {
            try {
                ...
                // — en versiones anteriores un bug podía guardar objetos (por ejemplo un evento)
                ...
                const normalized = parsed.map((p)=>{
                    ...
                    if (typeof prem === 'object' && prem !== null) {
                        ...
                        // Console.warn sólo la primera vez que migramos
                ...
                // Si hemos normalizado algún premio, sustituimos los premios guardados
                // por la versión normalizada y marcamos la migración para no repetir el log.
        ...
        // Si no hay premios guardados, generar automáticamente
    ...
    const generarPremiosAutomaticos = ()=>{
        ...
        // ✅ ASIGNAR TROFEOS AUTOMÁTICAMENTE A LOS CENTROS GANADORES (solo si no se han asignado ya)
    ...
    const asignarTrofeoACentro = (nombreCentro, idTrofeo)=>{
        ...
        try {
            ...
            if (usuariosActualizados) {
                ...
                console.log(`🏆 Trofeo ${idTrofeo} asignado a usuarios del centro ${nombreCentro}`);
            }
        } catch (error) {
...
_s(CentrosCompetencia, "sY8Yu4wgDk3SmcXj9ZueHJtkh2w=");
...
//# sourceMappingURL=src_app_centros-competencia_page_tsx_193eeecc._.js.map